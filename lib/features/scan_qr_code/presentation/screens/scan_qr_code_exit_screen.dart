...
class ScanQRCodeExitScreen extends StatefulWidget {
  const ScanQRCodeExitScreen({super.key});

  @override
  State<ScanQRCodeExitScreen> createState() => _ScanQRCodeExitScreenState();
}

class _ScanQRCodeExitScreenState extends State<ScanQRCodeExitScreen> {
  ...
  void _onDetect(BarcodeCapture capture) async {
    ...
    try {
      ...
      final result = await qrService.markTicketAsExited(id, ticketId);
      ...
      _showResultDialog("Vé không hợp lệ hoặc đã được sử dụng vào trước đó!", isSuccess: false);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Quét Ra", style: TextStyle(fontWeight: FontWeight.bold)),
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: Icon(Icons.qr_code_scanner, size: 48, color: Colors.white70),
                          ),
                        ),
                      ],
                    ),
