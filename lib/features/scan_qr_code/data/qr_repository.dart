...
class QRRepository {
  ...
  Future<QRUpdateResult> updateTicketStatusToUse(String orderId, String ticketId) async {
    try {
  ...
  Future<QRUpdateResult> updateTicketStatusExit(String orderId, String ticketId) async {
    try {
      final response = await ApiClient.dio.put(
